      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          <div>
            ...
            <p className="text-gray-400 leading-relaxed">
              Pesantren Tadabbur Al-Qur'an Amsa001 Gadog Membentuk generasi Qurani yang berakhlak mulia
            </p>
          </div>
          <div>
            <h4 className="text-lg font-bold mb-3">Kontak</h4>
            <div className="space-y-2 text-gray-400">
              <p>📞 +62 813-2936-1375</p>
              <p>✉️ info@ptqamsa.id</p>
              <p>📱 @ptqamsa001</p>
            </div>
          </div>
          <div>
        ...
        <div className="border-t border-gray-800 pt-6 text-center">
          ...
          <div className="text-sm text-gray-500">
            © 2026 Pesantren Tadabbur Al-Qur'an Amsa001 Gadog. All rights reserved.
          </div>
        </div>
      </div>
    </footer>
