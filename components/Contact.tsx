            ...
            <div className="space-y-5">
              ...
              >
                ...
                <div>
                  ...
                  <div className="opacity-90">@ptqamsa001</div>
                </div>
              </a>
              <a 
                href="https://www.youtube.com/@pesantrentadabburalquranamsa" 
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-start gap-4 hover:opacity-80 transition"
              >
                ...
                <div>
                  <div className="font-bold text-lg mb-1">YouTube</div>
                  <div className="opacity-90">Pesantren Tadabbur Al-Qur'an Amsa</div>
                </div>
              </a>
              <a 
              ...
              >
                ...
                <div>
                  ...
                  <div className="opacity-90">info@ptqamsa.id</div>
                </div>
              </a>
              <a 
                href="https://www.facebook.com/profile.php?id=61588216673281&locale=id_ID" 
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-start gap-4 hover:opacity-80 transition"
              >
                ...
                <div>
                  <div className="font-bold text-lg mb-1">Facebook</div>
                  <div className="opacity-90">PTQ Amsa001</div>
                </div>
              </a>
            </div>
          </div>
